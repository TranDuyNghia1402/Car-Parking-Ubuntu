...
class ANPR:
    ...
    def locate_license_plate(self, gray, candidates, clearBorder=False):
        # initial the license plate countour and ROI
        lpCnt = None
        roi = None
        # loop over the license plate candidate contours
        for c in candidates:
            # compute the bounding box of the countour then use
            ...
            if ar >= self.minAR and ar <= self.maxAR:
                ...
                break
        # return a 2 tuple of the license plate ROI and contour
        # associated with it
        return (roi, lpCnt)
    ...
    def find_and_ocr(self, image, psm=7, clearBorder=False):
        ...
        lpText = None
        # convert the input image to gray scale, locate all candidate
        ...
        # return a 2 tuple of OCR'd license plate text along with
